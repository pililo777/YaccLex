...
//  UserName: usuario
//  GPLEX input file <Calculator.Language.analyzer.lex - 07/03/2019 17:16:15>
...
Console.WriteLine("mult token: {0}", yytext);		return (int)Token.OP_MULT;
            break;
        case 5: // Recognized '{OpPlus}',	Shortest string "+"
Console.WriteLine("El token: {0}", yytext);		return (int)Token.OP_PLUS;
            break;
